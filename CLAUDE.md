...
- ✅ Multi-manager pilot: אביגיל שפיגלמן + מרים נידאם + פייגי צלניקר
...
3. **טיוטה כפולה:** פייגי דיווחה על טיוטה שהופיעה פעמיים — טרם אובחן הגורם
4. **תוכן מייל מעסיק:** להסיר עמודת "קוד שגיאה", להוסיף "חודש שכר" (בקשת עידו)
